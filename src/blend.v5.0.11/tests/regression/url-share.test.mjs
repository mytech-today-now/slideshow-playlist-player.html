...
test('compact URL transport preserves full experience state and extensions', () => {
  const experience = {
    version: '5.0.11', schema: 'player.blend.experience.v2', type: 'experience',
    id: 'exp-1', name: 'Compact', project: 'Compact', exportedAt: '2026-07-10T00:00:00.000Z',
    settings: { defaultImageDuration: 4, transitionOverlapMs: 250 },
    ui: { activeList: 'slideshow' },
    library: {
      order: ['video'],
      items: [{ order: 0, id: 'video', path: 'media/video.mp4', fullPath: 'media/video.mp4', pathKind: 'relative', name: 'Video', type: 'video', size: 12, duration: 42, addedAt: 1, stale: false, customTag: 'keep-me' }]
    },
    playlist: { version: '5.0.11', schema: 'player.blend.list.v1', type: 'playlist', name: 'Playlist', description: '', createdAt: 1, project: 'Compact', exportedAt: '2026-07-10T00:00:00.000Z', order: ['video'], items: [{ order: 0, id: 'video', path: 'media/video.mp4', fullPath: 'media/video.mp4', pathKind: 'relative', name: 'Video', type: 'video', size: 12, duration: 42, addedAt: 1, available: true }] },
    slideshow: { version: '5.0.11', schema: 'player.blend.list.v1', type: 'slideshow', name: 'Slideshow', description: '', createdAt: 1, project: 'Compact', exportedAt: '2026-07-10T00:00:00.000Z', order: [], items: [] }
  };
  const compact = serializeExperienceForShare(experience);
  assert.equal(compact[0], COMPACT_SHARE_MAGIC);
  assert.equal(compact[1], COMPACT_SHARE_VERSION);
  assert.deepEqual(deserializeExperienceFromShare(compact), experience);
});
