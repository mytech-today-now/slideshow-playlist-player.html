import { attachGlobalErrorHandlers, createLogger } from './logger.js?v=20260619-v4.8';
import { createPointerReorderFallback } from './drag-sort.js?v=20260619-v4.8';
...
const VERSION = '4.8';
const CACHE_VERSION = 'blend-player-v4.8-20260619';
...
function wireTransport() {
  ...
  if (shareBtn) {
    ...
    shareBtn.onclick = () => {
      const context = activeExperienceContext || contextFromRuntimeLayer('slideshow') || contextFromRuntimeLayer('playlist') || buildProjectContext();
      openShareMenuForContext(shareBtn, context);
    };
  }
