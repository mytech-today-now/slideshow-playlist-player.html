...
const APP_SHELL = [
  ...
  './styles.css?v=20260626-v5.0.8-exp-load',
  './app.js?v=20260626-v5.0.8-exp-load',
  './experience-load-progress.js?v=20260626-v5.0.8-exp-load',
  './url-share.js?v=20260626-v5.0.8-exp-load',
  './logger.js?v=20260626-v5.0.8-exp-load',
  './drag-sort.js?v=20260626-v5.0.8-exp-load',
  './supabase-config.js?v=20260626-v5.0.8-exp-load',
  './supabase-auth.js?v=20260626-v5.0.8-exp-load',
  './storage-url-resolver.js?v=20260626-v5.0.8-exp-load',
  './playback-clock.js',
  './markdown.js',
  './supabase-config.js',
  './supabase-auth.js',
