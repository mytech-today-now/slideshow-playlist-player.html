...
import { fetchReadme } from './readme-fetcher.js?v=20260626-v5.0.10-github-readme';
import {
  compressExperience,
  ...
  URL_MAX_LENGTH
} from './url-share.js?v=20260626-v5.0.9-url-limit';
import {
  analyzeExperienceSize,
  buildSizeBreakdownHtml
} from './url-share-diagnostics.js?v=20260626-v5.0.9-url-limit';
...
const VERSION = '5.0.9';
const CACHE_VERSION = 'blend-player-v5.0.9-20260626-url-limit';
