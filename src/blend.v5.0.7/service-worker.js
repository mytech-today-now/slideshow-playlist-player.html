...
const APP_SHELL = [
  ...
  './styles.css?v=20260626-v5.0.7-url-share',
  './app.js?v=20260626-v5.0.7-url-share',
  './url-share.js?v=20260626-v5.0.7-url-share',
  './logger.js?v=20260626-v5.0.7-url-share',
  './drag-sort.js?v=20260626-v5.0.7-url-share',
  './supabase-config.js?v=20260626-v5.0.7-url-share',
  './supabase-auth.js?v=20260626-v5.0.7-url-share',
  './storage-url-resolver.js?v=20260626-v5.0.7-url-share',
  './playback-clock.js',
  './markdown.js',
  './supabase-config.js',
  './supabase-auth.js',
