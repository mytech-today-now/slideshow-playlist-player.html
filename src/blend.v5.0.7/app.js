import { attachGlobalErrorHandlers, createLogger } from './logger.js?v=20260626-v5.0.7-url-share';
import { createPointerReorderFallback } from './drag-sort.js?v=20260626-v5.0.7-url-share';
import { computeMoveOrder, isIdentityOrder, buildIndexRemap } from './list-reorder.js?v=20260626-v5.0.7-url-share';
import { getBlendRuntimeConfig } from './supabase-config.js?v=20260626-v5.0.7-url-share';
import { createSupabaseAuthClient, SupabaseAuthError } from './supabase-auth.js?v=20260626-v5.0.7-url-share';
import {
...
} from './storage-url-resolver.js?v=20260626-v5.0.7-url-share';
import {
  createTransitionManager,
  defaultTransitionSettings,
  listTransitionEffects,
  normalizeTransitionSettings
} from './transition-manager.js?v=20260626-v5.0.7-url-share';
import {
  TRANSPORT,
  transportToggleAction,
  ElapsedClock,
  PausableTimer
} from './playback-clock.js?v=20260626-v5.0.7-url-share';
import { renderMarkdown } from './markdown.js?v=20260626-v5.0.7-url-share';
import {
  compressExperience,
...
} from './url-share.js?v=20260626-v5.0.7-url-share';
...
const VERSION = '5.0.7';
const CACHE_VERSION = 'blend-player-v5.0.7-20260626-url-share';
...
/**
 * Decompress and import an experience from a URL share request.
 * Cleans the query parameter from the URL after a successful load.
 *
...
async function loadUrlSharedExperience(request) {
  ...
  const toast = showToast('Loading shared experience…', { timeout: 0 });
  try {
    let parsed;
    try {
    ...
    if (!record) throw new Error('Share link experience payload is invalid');

    // Remove the share param from the URL so it doesn't reload on refresh.
    try {
    ...
    showToast(error?.message || 'Could not load shared experience', { timeout: 4800 });
    return null;
  } finally {
    toast.close();
  }
