import { attachGlobalErrorHandlers, createLogger } from './logger.js?v=20260622-v4.15-ipfs-worker-timeout-fallback';
import { createPointerReorderFallback } from './drag-sort.js?v=20260622-v4.15-ipfs-worker-timeout-fallback';
import {
  DEFAULT_IPFS_CONFIG,
  IPFS_GATEWAY_PARAM,
  IPFS_SHARE_PARAM,
...
const VERSION = '4.15';
const CACHE_VERSION = 'blend-player-v4.15-20260622-ipfs-worker-timeout-fallback';
...
const DEFAULT_IPFS_WORKER_URL = './ipfs-worker.js?v=20260622-v4.15-ipfs-worker-timeout-fallback';
const DEFAULT_IPFS_HELIA_MODULE_URL = './ipfs-helia-provider.bundle.js?v=20260622-v4.15-ipfs-worker-timeout-fallback';
const DEFAULT_SETTINGS = {
  ...
  themeMode: 'auto',
  ipfsEnabled: true,
  ipfsMode: DEFAULT_IPFS_CONFIG.mode,
