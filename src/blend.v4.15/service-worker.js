...
const APP_SHELL = [
  ...
  './styles.css?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './app.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './logger.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './drag-sort.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-service.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-manifest.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-share-warning.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-worker.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-helia-provider.bundle.js?v=20260622-v4.15-ipfs-worker-timeout-fallback',
  './ipfs-service.js',
  './ipfs-manifest.js',
